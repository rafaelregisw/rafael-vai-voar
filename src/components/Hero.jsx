      ...
      <div className="relative z-20 text-center px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto">
        ...
        >
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="px-10 py-4 bg-gradient-to-r from-azul-horizonte to-azul-ceu text-white font-semibold text-lg rounded-full shadow-xl hover:shadow-2xl transition-all duration-300"
          >
